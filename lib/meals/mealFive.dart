...
class mealFive extends StatefulWidget {
  @override
  State<mealFive> createState() => _mealFiveState();
}

class _mealFiveState extends State<mealFive> {
  ////for MEAL Six
  ...
  void _increaseCardHeight5() {
    setState(() {
      ...
      _editButton5 = true;
      _buttonWidth5 = _buttonWidth5 == 0.36 ? 0.25 : 0.36; // Toggle between widths
    });
  }

  // Initializing meal list
  final List<mealItem> _mealList5 = [
    mealItem(name: "Spicy Bacon Cheese Toast", calCount: 312, flag: false),
