...
// ABOVE ARE FOR MEAL ONE
  ...
  void _increaseCardHeight5() {
    setState(() {
      _baseHeight5 =
          _baseHeight5 == 0.15 ? 0.35 : 0.15; // Toggle between two heights
      _editButton5 = true;
      _buttonWidth5 =
          _buttonWidth5 == 0.36 ? 0.25 : 0.36; // Toggle between widths
    });
  }
                                                  ...
                                                  onTap: () {
                                                    ...
                                                    setState(() {
                                                      ...
                                                      for (var item
                                                          in _mealList5) {
                                                        item.flag =
                                                            _isEditing5; // Set flag based on edit mode
                                                      }
                                                    });
                                                  },
                                                  child: Container(
